...
function run(_ref) {
  ...
  var templateVDomCreateList = [{
    ...
    "attributes": [],
    "children": [{
      "content": "pages/calculate/calculate.wxml",
      "uid": 2
    }],
    "uid": 1
  }, {
  ...
  function walkTemplate(template, data, preTemplate) {
    ...
    for (var i = 0; i < attributes.length; i++) {
      ...
      if (typeof _value === "function") {
        // 加入变化范围
        var _realKey = keyJoin(prekey, "attributes[".concat(i, "].value"));
    ...
    vdom.attributes = attributes; // 遍历dataSet
